...
from llama_cookbook.datasets.userlm_dataset import get_preprocessed_flipped_dialogue as get_userlm_dataset
from llama_cookbook.datasets.distillation_dataset import get_preprocessed_distillation as get_distillation_dataset
DATASET_PREPROC = {
    ...
    "userlm_dataset": get_userlm_dataset,
    "distillation_dataset": get_distillation_dataset,
}
