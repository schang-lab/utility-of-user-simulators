...
class train_config:
    ...
    run_validation_before_train: bool=False
    ...
    dataset_path: str = "dataset_path_overriding" # custom
    eval_steps: int = 0 # Run evaluation every N steps (0 = only at end of epoch)
    warmup_ratio: float = 0.0 # Ratio of total training steps for learning rate scheduler warmup
    min_lr: float = 0.0 # Minimum learning rate for cosine decay with stable LR
    use_torch_compile: bool = False # Enable torch.compile to JIT-fuse kernels for faster training