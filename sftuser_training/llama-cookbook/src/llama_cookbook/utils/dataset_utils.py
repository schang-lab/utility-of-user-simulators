...
def get_preprocessed_dataset(
    ...
    override_datapath = kwargs.pop("override_datapath", None)
    model_name_string = kwargs.pop("model_name_string", None)
    assert override_datapath and model_name_string, (
        "override_datapath and model_name_string must be provided"
    )
    ...
    return DATASET_PREPROC[dataset_config.dataset](
        ...
        tokenizer,
        get_split(),
        override_datapath=os.path.join(Path.cwd(), override_datapath),
